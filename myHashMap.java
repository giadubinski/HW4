...
class myHashMap<K,V> {
    ...
    public V remove(K key) {
        ...
        /*
        While loop to check if the head is not null
        an if statement for if the key is found
        and if the first node has the key to set the bucket to the next node.
        Else skip the node.
         */
        while (head != null) {
            if (head.key.equals(key)) {
                ...
                //Returning the value to the node
                return head.value;
            }
    ...
    public V replace(K key, V val) {
        ...
        //Using HashNode to get the first node in the bucket
        HashNode<K, V> head = bucket.get(i);

        /*
        While loop to check if the head is not null
        An if statement for if the key is found
        It would store the old value and replace it with the new value
        then it would return to the old value
         */
        while (head != null) {
            if (head.key.equals(key)) {
        ...
        //This would return to null if the key is not found
        return null;
    }
    ...
    public boolean replace(K key, V oldVal, V newVal) {
        ...
        //Using HashNode to get the first node
        HashNode<K, V> head = bucket.get(i);

        /*
        While loop to check if the head is not null
        If statement to see if the key is found, and it equals the old value
